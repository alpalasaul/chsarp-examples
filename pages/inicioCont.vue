  ...
  <v-card>
    <v-responsive :aspect-ratio="16 /9">
      ...
      <v-card-text>
        ...
        <h3 style="text-align: center; margin-bottom: 10px">Gracias por formar parte de este equipo</h3>
        <h2 style="text-align: center; margin-bottom: 10px">Juntos Saldremos de esto</h2>
        <br />
